...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Submitting login with data:', { email: formData.email })

    try {
      const response = await api.post('/auth/login', formData)
      const { token, user } = response.data
      
      console.log('Login successful - Backend response:', { token, user })
      ...
      if (intendedDestination) {
        ...
        switch (user.role) {
          ...
          case 'teacher':
            ...
            break
          case 'admin':
            console.log('Admin user detected, should use admin login')
      ...
      <div className="flex items-center justify-center w-full max-w-6xl mx-auto relative z-10 px-4">
        <div className="w-full max-w-lg lg:max-w-xl">
          <Card className="w-full glass-card-advanced" style={{
            ...
            <CardTitle className="text-3xl font-bold login-title" style={{
            ...
            <CardDescription className="login-subtitle text-center" style={{
              color: '#CBD5E1',
              fontSize: '0.95rem',
              fontWeight: '500',
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <button 
                type="button"
                className="login-button-google w-full flex items-center justify-center gap-2 py-3 glass-button-secondary" 
                style={{
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="login-input modern-input w-full pr-12"
                    style={{
                      background: 'rgba(255, 255, 255, 0.05)',
                      backdropFilter: 'blur(20px) saturate(180%)',
                      WebkitBackdropFilter: 'blur(20px) saturate(180%)',
              ...
              <button 
                type="submit" 
                className="login-button-primary w-full py-3 glass-button-primary" 
                style={{
              ...
              <div className="text-center" style={{
                ...
                <AnimatedLink to="/forgot-password" animation="slide" className="text-sm" style={{
                  color: '#60a5fa',
                  fontWeight: '600',
                  textDecoration: 'none'
                }}>
              ...
              <div className="text-center space-y-2" style={{
                ...
                <div className="flex justify-center gap-3">
                  <AnimatedLink to="/student-register" animation="slide" className="group relative px-4 py-3 rounded-xl transition-all duration-500 hover:scale-105" style={{
                  ...
                  <AnimatedLink to="/teacher-register" animation="slide" className="group relative px-4 py-3 rounded-xl transition-all duration-500 hover:scale-105" style={{
